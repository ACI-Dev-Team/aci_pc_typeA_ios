...
-(instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _currentValue = 0.0f;
        _lineWidth = 5.0f;
        _unfilledColor = [NSColor colorWithRed:250/255.0f green:60/255.0f blue:20/255.0f alpha:1.0f];
        _filledColor = [NSColor colorWithRed:175/255.0f green:195/255.0f blue:5/255.0f alpha:1.0f];
...
-(void)mouseDragged:(NSEvent *)theEvent {
    ...
    CGPoint lastPoint = [self convertPoint:[theEvent locationInWindow] fromView:nil];
