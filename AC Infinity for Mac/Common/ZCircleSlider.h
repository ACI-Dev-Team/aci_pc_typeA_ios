...
@interface ZCircleSlider : NSControl

@property (nullable, nonatomic, strong) NSColor *backgroundTintColor;
@property (nullable, nonatomic, strong) NSColor *minimumTrackTintColor;
@property (nullable, nonatomic, strong) NSColor *maximumTrackTintColor;
@property (nullable, nonatomic, strong) NSColor *thumbTintColor;
